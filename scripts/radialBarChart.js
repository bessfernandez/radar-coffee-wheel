...
/* Disclamer - a lot of this code based off of: https://github.com/prcweb/d3-radialbar
   Updated with some improvements, comments, and general cleanup.
   @TODO - likely rewrite the core of this code and simplify, this is used as a basis
   on which to grow and test.
*/
...
function radialBarChart() {
  ...
  var domain = [0, 100];
  var colorLabels = true;
  var tickCircleValues = [];
  var transitionDuration = 400;

  // general vars
  var barColors, tickValues, numBars, barScale, keys, labelRadius;
  ...
  function init(d) {
    ...
    // Radius of the key labels, a little above the top of
    // the bar
  ...
  var chart = function(selection) {
    selection.each(function(d) {
      ...
      // create placeholder g node bound to data
      ...
      // reselect `g` with bound data, now added to DOM
